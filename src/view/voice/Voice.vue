        ...
        >
          ...
          >
            ...
            >
              <audio
                style="width: 360px"
                :src="`${$serverUrl}/voice/${this.addFormData.newUrl}`"
                :autoplay="false"
                controls="controls"
                ref="audio"
              >
                ...
                <li class="header">
                  <el-col :span="8" type="flex" justify="center">
                    <span
                      ...
                      class="pro-name"
                      ><el-tag style="font-size: 16px">语音播放</el-tag></span
                    >
                  </el-col>
                  <el-col :span="3">
                ...
                <el-col :span="16">
                  <div class="pro-name">
                    <audio
                      ...
                      controls="controls"
                      ref="audio"
                      @error="handleVoiceError(scope.row)"
                    >
                      您的浏览器不支持音频播放
                    </audio>
                  </div>
...
//导入视频上传组件
import VoiceUpload from "../../components/UploadVoice.vue";
